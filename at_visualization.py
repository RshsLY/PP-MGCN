...
parser.add_argument("--lr", type=float,                  default=0.000005,           help="Learning rate of model training")
...
pil_img.save("hm/ori"+args.WSI_name+str(args.layer_select)+'.png')
heat_map1.save("hm/heatmap"+args.WSI_name+str(args.layer_select)+'.png')
final_img.save("hm/final"+args.WSI_name+str(args.layer_select)+'.png')